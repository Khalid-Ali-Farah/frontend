  ...
  return (
    <div>
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
        ...
        <div>
        <h1 className='text-2xl font-bold md:text-3xl py-5'><span className='text-red-600'>KH</span>ULOOD.</h1>
        ...
        <div>
          ...
          <ul className='flex flex-col gap-1 text-gray-600'>
            ...
            <li>contact@khuloodonlineshopyou.com</li>
          </ul>
        </div>
      ...
      <div>
        <hr />
        <p className='py-5 text-sm text-center'>Copyright 2024@ Khulood Online Shop.com - All Right Reserved.</p>
      </div>
